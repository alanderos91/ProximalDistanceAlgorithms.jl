function main()
    ...
    allocs = Dict(
        # easy problem
        (1,  50, :MM) => ("0:10:00", "1G")
        (1,  50, :SD) => ("0:10:00", "500M")
        (1, 100, :MM) => ("0:10:00", "1G")
        (1, 100, :SD) => ("0:10:00", "500M")
        (1, 200, :MM) => ("0:10:10", "1G")
        (1, 200, :SD) => ("0:10:00", "500M")
        (1, 400, :MM) => ("0:10:00", "1G")
        (1, 400, :SD) => ("0:10:00", "500M")
        # modest problem
        (10,  50, :MM) => ("0:10:00", "1G")
        (10,  50, :SD) => ("0:10:00", "500M")
        (10, 100, :MM) => ("0:10:00", "1G")
        (10, 100, :SD) => ("0:10:00", "500M")
        (10, 200, :MM) => ("0:45:00", "1G")
        (10, 200, :SD) => ("0:10:00", "500M")
        (10, 400, :MM) => ("1:15:00", "6G")
        (10, 400, :SD) => ("0:10:00", "500M")
        # hard problem
        (20,  50, :MM) => ("0:30:00", "1G")
        (20,  50, :SD) => ("0:10:00", "500M")
        (20, 100, :MM) => ("0:45:00", "1G")
        (20, 100, :SD) => ("0:10:00", "500M")
        (20, 200, :MM) => ("2:00:00", "2G")
        (20, 200, :SD) => ("0:10:00", "500M")
        (20, 400, :MM) => ("4:00:00", "12G")
        (20, 400, :SD) => ("0:10:00", "500M")
    )
